...
| [`2026-07-29-ordinary-ci-repair.md`](./2026-07-29-ordinary-ci-repair.md) | Ordinary Windows CI failure analysis, narrow locally rechecked repair, and green same-SHA ordinary CI evidence. |
...
| [`canonical-ledger-hashing.md`](./canonical-ledger-hashing.md) | Event-chain digest made canonical (key-sorted), verified from an independent Python implementation, and the ledger reset that followed. Archived pre-change events are not release evidence. |
